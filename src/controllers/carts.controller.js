    ...
    static async addProduct(req, res) {
        try {
            ...
            if (user.role === 'premium' && product.owner === user.email) {
                req.logger.warning(`El producto id ${pid} pertenece al usuario id ${user._id} y no se puede agregar al carrito`);
                return res.sendUserError(`El producto id ${pid} pertenece al usuario id ${user._id} y no se puede agregar al carrito`);
            }
